...
namespace Manager.Scene {
	...
	public class GameManager : MonoBehaviour {
		...
		private float minimumRespawnTime = 0.5f;
		...
		private const float MAX_ENEMY_DISTANCE = 60;
		...
		public void generateSparkle(Vector3 position, Quaternion rotation) {
			...
			sparkleEffect.GetComponent<ParticleSystemManager>().activate();
		}
		...
		public void generateBlood(Vector3 position) {
			...
			bloodObject.GetComponent<ParticleSystemManager>().activate();
		}
		...
		public void generateCasing(Vector3 position, Quaternion rotation) {
			...
			casingObject.GetComponent<CasingManager>().activate();
		}
